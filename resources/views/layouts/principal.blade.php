...
<head>
	...
	<script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false);
		...
		<!-- //banner-slider -->
		<!-- pop-up -->
		<link href="css/popubox.css" rel="stylesheet" type="text/css" media="all" />
		<!-- //pop-up -->
		<!-- font-awesome icons -->
	...
	<body>
		...
		<div class="header">
			<div class="container">
				<div class="w3layouts_logo">
					<a href="/"><h1>Cine<span>Mil</span></h1></a>
				</div>
				<div class="w3_search">
		...
		<!-- //header -->
		<!-- bootstrap-pop-up -->
		<div class="modal video-modal fade" id="myModal" tab/="-1" role="dialog" aria-labelledby="myModal">
		...
		<div class="container">
			<div class="w3ls_footer_grid">
				...
				<div class="col-md-6 w3ls_footer_grid_right">
					<a href="/"><h2>One<span>Movies</span></h2></a>
				</div>
				<div class="clearfix"> </div>
			</div>
